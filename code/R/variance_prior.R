...
## opt=list(filea='/public/home/liujf/liwn/mbGS/Real/YCJY/rmodel/AGE/YY/val#val#/rep#rep#/pheno.txt', fileb='/public/home/liujf/liwn/mbGS/Real/YCJY/rmodel/AGE/LL/val#val#/rep#rep#/pheno.txt', rep=5, fold=5, h2=0.5, h2B=0.5, rg=0.001, re =0.001, type='multi', var='pheno', norec=TRUE, add_rf=1, pcol=6, rg_local='/public/home/liujf/liwn/mbGS/Real/YCJY/rmodel/AGE/multi/ind_B_100.txt2~', out='/public/home/liujf/liwn/mbGS/Real/YCJY/rmodel/AGE/multi/val#val#/rep#rep#/multi_ind_prior.txt', overwri=1)
